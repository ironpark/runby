...
const (
	...
	CIVercel            CIProvider = "vercel"
	CINetlify           CIProvider = "netlify"
	CITeamCity          CIProvider = "teamcity"
	CIDrone             CIProvider = "drone"
	CIAppVeyor          CIProvider = "appveyor"
	CISemaphore         CIProvider = "semaphore"
	CICirrus            CIProvider = "cirrus-ci"
	CIAWSCodeBuild      CIProvider = "aws-codebuild"
	CIGoogleCloudBuild  CIProvider = "google-cloud-build"
	CIGiteaActions      CIProvider = "gitea-actions"
